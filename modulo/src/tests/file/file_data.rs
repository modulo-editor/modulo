...
fn test_insert_text() {
    let mut file_data = FileData::new();
    file_data.set_selections(vec!(SelectionRange::new(Point::new(0, 0), None)));
...
fn test_replace_text() {
    ...
    file_data.set_selections(vec!(SelectionRange::new(Point::new(0, 0), Some(Point::new(0, 2)))));
